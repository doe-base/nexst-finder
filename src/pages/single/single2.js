        ...
        <main className={classes.main}>
            ...
            <div className={classes.top}>
                <div className={classes.overlay}>
                    ...
                    <div className={classes.tag}>
                        <p className={classes.tagP}>Electrician</p>
                    </div>
                    <div className={classes.mainTitle}>
                        <h2 className={classes.h2}>Gaturco Limited</h2>
                    </div>
                </div>
            </div>
            ...
            <div className={classes.bottom}>
                ...
                <div className={classes.secondSection}>
                    <div>
                        <p className={classes.creditText}><span>By</span><span className={classes.brandName}>Gaturco Limited</span><br />
                ...
                <div className={classes.fifthSection}>
                    <div className={classes.textHolder}>
                        ...
                        <span className={classes.p} >Did you enjoy <span style={{color: '#bb9c2d'}}>Gaturco Limited</span> services?</span>
                    </div>
                    <div className={classes.textHolder}>
